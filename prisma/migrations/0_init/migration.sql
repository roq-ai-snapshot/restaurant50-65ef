...
CREATE TABLE "table_status" (
    ...
    CONSTRAINT "table_status_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "order" ADD CONSTRAINT "order_wait_staff_id_fkey" FOREIGN KEY ("wait_staff_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "restaurant_table" ADD CONSTRAINT "restaurant_table_restaurant_id_fkey" FOREIGN KEY ("restaurant_id") REFERENCES "restaurant"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "restaurant_table" ADD CONSTRAINT "restaurant_table_status_id_fkey" FOREIGN KEY ("status_id") REFERENCES "table_status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
